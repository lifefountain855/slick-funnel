  ...
  return (
    <div className="py-24 bg-slate-50 min-h-screen">
      <div className="container mx-auto px-4 md:px-8 max-w-3xl">
        <h1 className="font-serif text-4xl md:text-5xl font-bold text-navy mb-8 text-center">About SlickFunnel</h1>
        ...
        <div className="prose prose-lg mx-auto text-slate-700">
          ...
          <p className="mb-6">
            SlickFunnel was built to solve a specific problem: local businesses are tired of paying thousands of dollars for generic websites that don't generate any real phone calls or leads.
          </p>
          <p className="mb-6">
          ...
          <div className="bg-white p-8 rounded-2xl border border-slate-100 my-8 shadow-sm">
            ...
            <ul className="space-y-4">
              ...
              <li><strong>All-in-one.</strong> Stop juggling 5 different subscriptions for hosting, forms, and CRM.</li>
